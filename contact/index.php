...
<body id="contact">
        <!--[if lt IE 8]>
            ...
            <div class="jumbotron" id="header">
              <div class="container dark-nav-items">
               <nav class="navbar wow fadeIn" data-wow-duration=".8s" data-wow-delay=".2s" role="navigation">
                ...
                <h1>Wir sind bereit</br>für Dein Projekt.</h1>
                <p>Melde Dich einfach per Formular, Mail, Telefon, Skype, Facebo…</p>
              </div>
            </div>

            <div class="row" id="contact-row">
              <div class="col-sm-6 col1">
                <form id="contactform" method="post" action="contactengine.php" role="form" data-toggle="validator">
                  ...
                  <div class="form-group has-error">
                    <input type="email" class="form-control" id="inputEmail" name="Email" placeholder="Email" data-error="Ung&uuml;ltige Emailadresse" required>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group has-error">
                    <input type="text" class="form-control" id="inputSubject" name="Subject" placeholder="Betreff" data-error="Bitte geben Sie einen Betreff an." required>
                    <div class="help-block with-errors"></div>
                  </div>
                  <div class="form-group has-error">
              ...
              <div class="col-sm-6 col2">
                <ul>
                  <h1>Kontaktdaten</h1>
                  <li>
                    <a href="mailto:projekt@munum.de">projekt@munum.de</a>
                  </li>
                  <li>
                   <address>
